    ...
    <div class="quiz-phone">
      <div class="quiz-content">
        <div class="quiz-content-half quiz-content-top">
          ...
          <p class="quiz-question"><b>Frage:</b><br><br>Lorem ipsum dolor sit amet, <span>consetetur sadipscing </span>elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat?</p>
        </div>
        <div class="quiz-content-half quiz-content-bottom">
          <a href="#answer-a" data-quiz="false" class="quiz-button">A: 50%</a>
          <a href="#answer-b" data-quiz="false" class="quiz-button">B: 10%</a>
          <a href="#answer-c" data-quiz="true" class="quiz-button">C: 90%</a>
          <a href="#answer-d" data-quiz="false" class="quiz-button">D: 1%</a>
        </div>
